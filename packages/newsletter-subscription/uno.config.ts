...
export default defineConfig<Theme>({
  ...
  shortcuts: [
    ...
    ['nortic-newsletter--input-label', 'block text-base font-normal'],
    ['nortic-newsletter--input', 'block w-full pl-2 py-2 rounded-lg border border-solid bg-variable-input placeholder:text-variable-placeholder border-variable-border box-border'],
    ['nortic-newsletter--input-hint', 'block text-xs text-variable-sub mt-0.5 pl-2'],
    ['nortic-newsletter--input-error', 'text-variable-error'],
    ['nortic-newsletter--tag-wrapper', 'mb-8'],
    ['nortic-newsletter--tag-title', 'text-lg font-semibold text-variable-text mt-2 mb-1  '],
    ['nortic-newsletter--subscribe-btn', 'flex items-center justify-center cursor-pointer gap-2 w-full p-2 mt-4 text-lg rounded-lg transition-colors duration-300 bg-black hover:bg-black/80 text-white text-center shadow-none border-none disabled:opacity-50 [&>span]:inline-block'],
    ['nortic-newsletter--loading-spinner', 'i-eos-icons-loading'],
    ['nortic-newsletter--form-error-wrapper', 'text-variable-error px-4 bg-variable-error/20 py-2 rounded-lg mt-4 [&>p]:my-0'],
    ['nortic-newsletter--affiliation', 'mt-4 mb-0 inline! opacity-100! float-right text-xs text-gray-800 px-2 py-1 bg-white border border-variable-border border-solid rounded-md text-right [&>a]:(text-nortic font-semibold decoration-none)'],
    ['nortic-newsletter--affiliation-logo', 'i-nortic-logo inline-block ml-1 text-base'],
